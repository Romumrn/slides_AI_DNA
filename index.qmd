...
::: {.columns}
::: {.column width="60%"}
**Definition**: Each token is transformed into a vector that captures its relationships with others.
...
![Fig: Nucleotide Transformer](img/training.png){fig-align="center"}
